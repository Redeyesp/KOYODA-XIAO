...
public:
    ...
    /*
     * KOYODA-XIAO board-specific visual shell hook.
     * Default implementation is a no-op so other XiaoZhi boards are unaffected.
     */
    virtual void SetKoyodaIdleVisible(bool visible);
